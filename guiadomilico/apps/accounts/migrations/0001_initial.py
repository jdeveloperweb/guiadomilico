    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Obrigatório no máximo 15 caracteres. São permitidos letras, números e "." "-" "_"', max_length=15, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.-_]+$'), 'Digite um nome de usuário válido.', 'Inválido.')], verbose_name='Nome de Usuário')),
                ...
                ('genero', models.CharField(blank=True, choices=[('M', 'Masculino'), ('F', 'Feminino'), ('O', 'Outros')], max_length=1, null=True)),
                ('avatar', models.PositiveSmallIntegerField(choices=[(0, 'user'), (1, 'captain'), (2, 'captain-1'), (3, 'detective'), (4, 'detective-1'), (5, 'firefighter'), (6, 'firefighter-1'), (7, 'judge'), (8, 'judge-1'), (9, 'judge-2'), (10, 'judge-3'), (11, 'police'), (12, 'police-1'), (13, 'police-2'), (14, 'police-3'), (15, 'police-4'), (16, 'police-5'), (17, 'police-6'), (18, 'police-7'), (19, 'police-8'), (20, 'police-9'), (21, 'police-10'), (22, 'police-11'), (23, 'sailor'), (24, 'sailor-1'), (25, 'swat'), (26, 'swat-1')], default=0)),
                ('role', models.PositiveSmallIntegerField(choices=[(0, 'Administrador'), (1, 'Gerente'), (2, 'Editor'), (3, 'Moderador'), (9, 'Usuario')], default=9)),
                ('is_staff', models.BooleanField(default=False)),
                ('is_active', models.BooleanField(default=True)),
                ('data_criacao', models.DateTimeField(editable=False)),
                ('data_edicao', models.DateTimeField()),
                ('is_trusty', models.BooleanField(default=False, help_text='Mostra se o usuário ativou ou não sua conta.', verbose_name='Confiável')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='PessoaFisica',
            fields=[
                ('usuario_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='pessoa_fis_info', serialize=False, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            name='PessoaJuridica',
            fields=[
                ('usuario_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='pessoa_jur_info', serialize=False, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario_tel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='telefone', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Site',
            fields=[
                ...
                ('usuario_site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='site', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Endereco',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_endereco', models.CharField(blank=True, choices=[('RES', 'Residencial'), ('COM', 'Comercial'), ('COB', 'Cobrança'), ('ENT', 'Entrega')], max_length=3, null=True)),
                ...
                ('codigo_pais', models.CharField(blank=True, default='1058', max_length=5, null=True)),
                ('municipio', models.CharField(blank=True, max_length=64, null=True)),
                ('codigo_mun', models.CharField(blank=True, max_length=9, null=True)),
                ...
                ('usuario_end', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='endereco', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Documento',
            fields=[
                ...
                ('usuario_documento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documento', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Banco',
            fields=[
                ...
                ('usuario_banco', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='banco', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='usuario',
            name='endereco_padrao',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='end_padrao', to='accounts.Endereco'),
        ),
        migrations.AddField(
            model_name='usuario',
            name='groups',
        ...
        migrations.AddField(
            model_name='usuario',
            name='site_padrao',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sit_padrao', to='accounts.Site'),
        ),
        migrations.AddField(
            model_name='usuario',
            name='telefone_padrao',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tel_padrao', to='accounts.Telefone'),
        ),
        migrations.AddField(
            model_name='usuario',
