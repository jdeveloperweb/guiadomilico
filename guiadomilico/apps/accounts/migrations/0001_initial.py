    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uf', models.CharField(blank=True, choices=[('AC', 'Acre'), ('AL', 'Alagoas'), ('AP', 'Amapá'), ('AM', 'Amazonas'), ('BA', 'Bahia'), ('CE', 'Ceará'), ('DF', 'Distrito Federal'), ('ES', 'Espírito Santo'), ('GO', 'Goiás'), ('MA', 'Maranhão'), ('MT', 'Mato Grosso'), ('MS', 'Mato Grosso do Sul'), ('MG', 'Minas Gerais'), ('PA', 'Pará'), ('PB', 'Paraíba'), ('PR', 'Paraná'), ('PE', 'Pernambuco'), ('PI', 'Piauí'), ('RJ', 'Rio de Janeiro'), ('RN', 'Rio Grande do Norte'), ('RS', 'Rio Grande do Sul'), ('RO', 'Rondônia'), ('RR', 'Roraima'), ('SC', 'Santa Catarina'), ('SP', 'São Paulo'), ('SE', 'Sergipe'), ('TO', 'Tocantins')], max_length=3, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Pessoa',
            fields=[
                ...
                ('email_padrao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ema_padrao', to='accounts.Email')),
                ('endereco_padrao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='end_padrao', to='accounts.Endereco')),
            ],
        ),
        migrations.CreateModel(
            name='Cliente',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pessoa_tel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='telefone', to='accounts.Pessoa')),
            ],
        ),
        migrations.CreateModel(
            name='Site',
            fields=[
                ...
                ('pessoa_site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='site', to='accounts.Pessoa')),
            ],
        ),
        migrations.AddField(
            model_name='pessoa',
        ...
        migrations.AddField(
            model_name='endereco',
            name='pessoa_end',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='endereco', to='accounts.Pessoa'),
        ),
        migrations.AddField(
            model_name='email',
            name='pessoa_email',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='email', to='accounts.Pessoa'),
        ),
        migrations.CreateModel(
            name='Documento',
            fields=[
                ...
                ('pessoa_documento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documento', to='accounts.Pessoa')),
            ],
        ),
        migrations.CreateModel(
            name='Banco',
            fields=[
                ...
                ('pessoa_banco', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='banco', to='accounts.Pessoa')),
            ],
        ),
    ]
